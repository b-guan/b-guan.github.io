$(document).ready(function() {
  ...
  $(
    ".parallax, .hero, #bryan-guan, #about, #project, #among-other-things, #contact, #about-section, #highlight-section, #other-things-sec, .footer"
  ).each(function() {
  ...
  /*Smooth Scroll*/
  $(".href-project, .href-about, .href-contact, .href-other-things").click(
    function(e) {
  ...
  $("#close").click(function() {
    ...
    $("#highlight-section").css("background", "rgba(0,0,0,0)");
    $("#iconWrapper").css("display", "static");
  });
  ...
  //Genetic Project
  $("#gen-algorithm").on("mouseenter", function() {
    $("#gen-project").toggle();
    $("#gen-project").css("z-index", 10);
  });
  $("#gen-algorithm").on("mouseleave", function() {
    $("#gen-project").toggle();
    $("#gen-project").css("z-index", "auto");
  });

  //Active Simon
  $("#simon-wrapper").on("mouseenter", function() {
    $("#simon-project").toggle();
    $("#simon-project").css("z-index", 10);
    // if ($(window).width() < 769) {
    //   $("#simon-demo").removeAttr("href");
    // }
  });
  $("#simon-wrapper").on("mouseleave", function() {
    $("#simon-project").toggle();
    $("#simon-project").css("z-index", "auto");
  });
